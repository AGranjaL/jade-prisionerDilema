 ...
 * 
 */
public SelfOrgMaps (int iSideAux, int iInputSizeAux) {
	iInputSize = iInputSizeAux;
	iGridSide = iSideAux;
	//iCellSize = iMapSize / iGridSide;
	iRadio = iGridSide / 10;
 ...
 * 
 */
public int iGetBMU (double[] dmInput, boolean bTrain)
	{
	int x=0, y=0;
